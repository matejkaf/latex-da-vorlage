...
\begin{figure}[H]
  ...
  \label{fig:canvas_01}
\caption[]{Zwei Logos der HTL Braunau in einer Abbildung zusammengefasst.}
\end{figure}
...
\qquad
  \subfloat[Logo]{\label{fig:b}\includegraphics[width=.15\textwidth]{./media/images/htl_c_cmyk_rein.pdf}}
  \label{fig:canvas_04}
\caption[]{Dreimal das Logo der HTL Braunau.}
\end{figure}
